...
namespace WindowsFormsApp6
{
    public partial class Form1 : Form
    {
        ...
        private string SiraCagir()
        {
            ...
            if (queue.Count > 0)
            {
                SoundPlayer soundPlayer = new SoundPlayer(Properties.Resources.ses);
                soundPlayer.Play();
            ...
            {
                SoundPlayer soundPlayer = new SoundPlayer(Properties.Resources.ses2);
                soundPlayer.Play();
                return "--";
            }
        ...
        private void lblGise2_Click(object sender, EventArgs e)
        {
